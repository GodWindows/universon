...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="<?= e('meta.login.description') ?>">
    <meta name="keywords" content="<?= e('meta.login.keywords') ?>">
    ...
    <meta property="og:title" content="Universon — <?= e('meta.login.title') ?>">
    <meta property="og:description" content="<?= e('meta.login.og_description') ?>">
    <meta property="og:site_name" content="Universon">

    <!-- Twitter -->
    <meta name="twitter:card" content="summary">
    <meta name="twitter:url" content="https://universon.fr/pages/login.php">
    <meta name="twitter:title" content="Universon — <?= e('meta.login.title') ?>">
    <meta name="twitter:description" content="<?= e('meta.login.og_description') ?>">

    <!-- PWA -->
    <link rel="manifest" href="/manifest.json">

    <title><?= htmlspecialchars($site_title) ?> — <?= e('meta.login.title') ?></title>
...
<body>
    ...
    <div class="lang-corner"><?= lang_switcher() ?></div>
